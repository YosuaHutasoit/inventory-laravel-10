...
class PurchaseController extends Controller
{
    ...
    {
        if (auth()->user()->store_name == 'manajer') {
            $purchases = Purchase::count();
        } elseif (auth()->user()->store_name == 'admin') {
    ...
    public function store(StorePurchaseRequest $request)
    {
        ...
        try {
            Notif::create([
                "title" => "Notification",
                "description" => "New purchase ".$purchase['id']." has been placed",
                "date" => date('Y-m-d')
            ]); 
        } catch (\Throwable $th) {}
    ...
    public function update($uuid)
    {
        ...
        try {
            Notif::create([
                "title" => "Notification",
                "description" => "Purchase ".$purchase->id." has been approved",
                "date" => date('Y-m-d')
            ]); 
        } catch (\Throwable $th) {}
    ...
    public function destroy($uuid)
    {
        ...
        try {
            Notif::create([
                "title" => "Notification",
                "description" => "Purchase ".$uuid." has been deleted",
                "date" => date('Y-m-d')
            ]); 
        } catch (\Throwable $th) {}
