                        ...
                        {{-- -
                            ...
                            {{-- <div class="nav-item dropdown d-none d-md-flex me-3">
                                <a href="#" class="nav-link px-0" data-bs-toggle="dropdown" tabindex="-1" aria-label="Show notifications">
                                    ...
                                    <?php
                                        $unread = 0;
                                        foreach (App\Models\Notif::get() as $notification) {
                                ...
                                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                                    ...
                                    @forelse (App\Models\Notif::get() as $notification)
                                        <div class="dropdown-item d-flex align-items-center">
                                            <div class="me-3">
                                                <span class="status-dot {{ $notification->is_read ? 'bg-success' : 'bg-red' }} d-block"></span>
                                            </div>
                                            ...
                                            <div class="ms-auto">
                                                <a style="font-size: 12px;" href="{{ route('notifications.markAsRead', $notification->id) }}" class="text-success me-2">
                                                    Mark as Read
                                                </a>
                                                <a style="font-size: 12px;" href="{{ route('notifications.delete', $notification->id) }}" class="text-danger">
                                                    Delete
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="nav-item dropdown d-none d-md-flex me-3">
                                <a href="#" class="nav-link px-0" data-bs-toggle="dropdown" tabindex="-1" aria-label="Show notifications">
                                    ...
                                    <?php
                                        $unread = App\Models\Notif::where('is_read', 0)->count();
                                    ?>
                                ...
                                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                                    <span class="dropdown-header">Notifications</span>
                                    <div class="dropdown-menu-scroll" style="max-height: 300px; overflow-y: auto;">
                                        @forelse (App\Models\Notif::orderBy('date', 'desc')->get() as $notification)
                                            <div class="dropdown-item d-flex align-items-center">
                                                <div class="me-3">
                                                    <span class="status-dot {{ $notification->is_read ? 'bg-success' : 'bg-red' }} d-block"></span>
                                                </div>
                ...
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            ...
                            @if (Auth::user()->store_name == 'admin' || Auth::user()->store_name == 'gudang' || Auth::user()->store_name == 'manajer')
                            ...
                            {{-- @if (Auth::user()->store_name == 'admin' || Auth::user()->store_name == 'manajer') --}}
                            @if (Auth::user()->store_name == 'admin' || Auth::user()->store_name == 'manajer')
                            ...
                            @if (Auth::user()->store_name == 'admin' || Auth::user()->store_name == 'manajer' || Auth::user()->store_name == 'gudang')
                            ...
                            @if (Auth::user()->store_name == 'gudang')
                    ...
                    <div class="row text-center align-items-center">
                        <div class="col-12 mt-3 mt-lg-0">
                            <center>
                                ...
                                <a href="#" class="link-secondary">Sistem Informasi Inventaris Barang - Modera Furniture</a>
                            </center>
                        </div>
                    </div>
                </div>
